...
export default function ChatWindow({ messages = [], loading = false }) {
  return (
    <div id="chat-canvas" className="flex-1 overflow-y-auto px-6 py-24">
        ...
        {messages.length === 0 && !loading && (
          <div className="mt-28 flex flex-col items-center justify-center text-center">
            ...
            <p className="max-w-xl text-lg text-zinc-400">
              Upload PDFs, Word documents, text files, CSVs, or Excel sheets and
              ask questions in natural language. If the answer isn't in your
              documents, enable Web Search for internet-powered responses.
            </p>
          </div>
        )}
